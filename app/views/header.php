...
<html>
  ...
  <body>
    ...
    <header class="header">
     <link rel="shortcut icon" href="<?php echo asset_url('img/favicon.ico') ?>">
     <link rel="shortcut icon" href="<?php echo asset_url('img/favicon.ico') ?>">
      <nav class="navbar navbar-expand-lg fixed-top"><a href="<?php echo App::url(); ?>" class="navbar-brand"><img src="<?php echo asset_url('img/logo.png') ?>" style=" width: 200px;height: 50px"></a>
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          ...
          <?php if (!Auth::check()): ?>
              <div class="navbar-text">
                  <a href="account/auth/register.php"  class="btn btn-primary navbar-btn btn-shadow btn-gradient">Sign Up</a>
              </div>
          <div class="navbar-text">
