      ...
      <div class="container">
        <div class="row d-flex">
          <div class="col-lg-6 text order-2 order-lg-1">
            <h1 style="color:  #fff;"><?php echo Config::get('app.name'); ?> &mdash; The fastest and Reliable way to get Passive Income  </h1>
      ...
      <div class="container">
        ...
        <div id="myTab" role="tablist" class="nav nav-tabs">
          <div class="row">
            ...
            <div class="col-md-4"><a id="nav-third-tab" data-toggle="tab" href="#nav-third" role="tab" aria-controls="nav-third" class="nav-item nav-link"> <span class="number">3</span>Get paid with Interest After  <?php echo $settings->timeMargin; ?> days. Restart the Cycle again</a></div>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container text-center">
        ...
        <div class="grid row">
          <div class="item col-lg-4 col-md-6">
            ...
            <p>All members will automatically recommit 10% of their ROI and will be available on their next payment.</p>
          </div>
          <div class="item col-lg-4 col-md-6">
                ...
                <div class="col-sm-12 clearfix media-section">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="catamaran">No, You are only allowed to have one account. Only Guilders can manage other members account but No Multiple Account</p>
                        </div>
                    </div>
                </div> <!-- End Media Section -->
                <!-- Start Media Section -->
                ...
                <div class="col-sm-12 clearfix media-section">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="catamaran">You get <?php echo $settings->referralProfit ?>% of the FIRST package your referals sign up for. For instance, if you refer someone to the system and the person starts by joining a package of N10,000, your wallet will be credited with <?php echo $settings->referralProfit ?>% of N10,000 which is N500. However, after that package, the next time your referals invest into the system, you will not receive any compensation bonus.</p>
                        </div>
                    </div>
                </div> <!-- End Media Section -->
                <!-- Start Media Section -->
                ...
                <div class="col-sm-12 clearfix media-section">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="catamaran">Keep Calm, there is no need to worry here. Once the time assigned to a downline has been exhausted, the system will block the account of the downline and assign a new downline to pay you within 12 hours.</p>
                        </div>
                    </div>
                </div> <!-- End Media Section -->
            </div>
