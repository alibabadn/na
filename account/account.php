...
<div class="content-inner">
       ...
       if (isset($_GET['edit'])) {
          ...
          if ($user->userid == $_GET['edit']) {
            ...
            $RecBalance1 = DB::table('bank')->where('userid', $user_id)->first();
            if(!$RecBalance1) {
              $accountNum = rand(0000000000,9999999999);
              $user1 = DB::table('bank')->where('accountNum', $accountNum)->first();
              if ($user1) {
                $users1 = DB::table('bank')->where('accountNum', $accountNum)->first();
                if ($users1) {
                    ...
                    <div class="card-body">
                      <form method="POST" action="">
                       ...
                       <?php if (Auth::user()->role_id == "2"){ ?>
                          ...
                          <div class="form-group">
                              <label class="form-control-label">Bank Name <span style="color: red">(You can't edit this)</span></label>
                          <input type="text" name="bankname" readonly disabled value="<?php echo $user->bankname; ?>" placeholder="Bank Name" class="form-control">
                        </div>

                          <div class="form-group">
                         <label class="form-control-label">Account Number <span style="color: red">(You can't edit this)</span></label>
                          <input type="text" name="accountnumber" readonly disabled value="<?php echo $user->accountnumber; ?>" placeholder="Account Number" class="form-control">
                        </div>

                          <div class="form-group">
                         <label class="form-control-label">Account Name <span style="color: red">(You can't edit this)</span></label>
                          <input type="text" name="accountname" readonly disabled value="<?php echo $user->accountname; ?>" placeholder="Account Name" class="form-control">
                        </div>
