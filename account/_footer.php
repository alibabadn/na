          ...
          <footer class="main-footer">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6">
                  <p>©  <?php echo date('Y').' '.Config::get('app.name'); ?> All Right Reserved  |    <a href="mailto:uchimadarasan@gmail.com">Need This Script?</a> </p>
                </div>
                <div class="col-sm-6 text-right">
                 <p>Modified by <a href="#" class="external">Madara</a></p>
